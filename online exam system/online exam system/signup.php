...
<body style="margin: 0;height: 100%;min-height: 100%;color: black !important; background-color:#e1f5fe">
<div style="font-family: 'Courier New', Courier, monospace;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;background-image: url(images/reset1.jpg);height: auto !important;background-repeat: no-repeat;background-size:cover;">
        <center>
            <h1 style="text-transform: uppercase;padding: 2vw;background-color: #white;color: black;margin-top:0;">ONLINE
        ...
        <div class="stud" id="stud">
            <center>
                ...
                <form name="student" method="POST" style="width: 80vw;background-color:#cfd8dc;"><br>
                    ...
                    <input type="submit" class="su" name="studsu" value="Sign-Up as Student" style="background-color:#03a9f4">
                </form>
        ...
        <div class="staff" id="staff">
            <center>
                ...
                <form name="staffSIGNUP" method="POST" style="width: 80vw;background-color:#cfd8dc;"><br>
                    ...
                    <input type="submit" name="staffsu" class="su" value="Sign-Up as Staff" style="background-color:#03a9f4">
                </form>
            </center>
        </div>
        <center><a href="index.php" style="color:black !important;">Cancel</a></center>
    </div>
