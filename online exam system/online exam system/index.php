...
<div class="bg" style="font-weight: bolder;background-image: url(./images/bg.jpg);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Arial black', monospace;opacity: 0.9;height: 100%;">
        <center>
            <h1 class="w3-container" style=" color:black; text-transform: uppercase; width: auto; background:white;background-size: cover;font-family: 'Arial black'; padding: 1vw;"><marquee direction="left">ONLINE
                Examination System</h1>
    </marquee>
        </center>
        <left>
            <div class="w3-card" class="login" style="color: black;width: 35vw;background-color: #white;border: 1px solid black;padding: 2vw;font-weight: bolder;margin-top: 3vh;border-radius: 10px;">
                <form method="POST">
                    <div class="seluser">
                    ...
                    <div class="signin">
                        ...
                        <br><br>
                        <input name="login" class="sub" type="submit" value="Login" style="height: 3vw;width: 10vw;font-family: 'times new roman', monospace;font-weight: bolder;border-radius: 10px;border: 1px solid black;background-color:#caaa94"><br>
