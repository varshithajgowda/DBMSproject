...
<body style="margin:0;height: 100%;outline:none;color: #042A38f !important;padding-botton:5vw;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/vinay.jpg);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: 100%;">
        <center>
            <h1 class="w3-container" style=" color:black;text-transform: uppercase;width: auto;background:lightblue;padding: 1vw;">ONLINE
